...
// func (cl *certLog) resetForView(newView int64) {
// 	cl.view = newView
// 	cl.prePrepare = nil
// 	cl.digest = nil
// 	cl.prepares = make(map[int64][]byte)
// 	cl.commits = make(map[int64][]byte)
// 	cl.prepareSent = false
// 	cl.commitSent = false
...
// // matchingVotes counts how many votes in the map have a digest equal to target.
// func matchingVotes(votes map[int64][]byte, target []byte) int {
// 	count := 0
// 	for _, d := range votes {
// 		if digestEqual(d, target) {
// 			count++
// 		}
// 	}
// 	return count
...
// 	if !cl.prepareSent {
// 		cl.prepareSent = true
// 		cl.prepares[n.NodeID] = expectedDigest
// 		cl.mu.Unlock()
// 		n.broadcastPrepare(cl, view, pp.SeqNum, expectedDigest)
// 	} else {
// 		cl.mu.Unlock()
// 	}
...
// 	cl.prepares[p.SenderID] = p.Digest
// 	cl.mu.Unlock()
...
// 	cl.commits[c.SenderID] = c.Digest
// 	cl.mu.Unlock()
...
// 	if matchingVotes(cl.commits, cl.digest) < n.quorumSize() {
// 		return
// 	}
