...
const (
	TriggerMode_TRIGGER_MODE_PERIODIC    TriggerMode = 0
	TriggerMode_TRIGGER_MODE_PERFORMANCE TriggerMode = 1
	TriggerMode_TRIGGER_MODE_FIXED       TriggerMode = 2
	TriggerMode_TRIGGER_MODE_NULL        TriggerMode = 3
)

// Enum value maps for TriggerMode.
var (
	TriggerMode_name = map[int32]string{
		0: "TRIGGER_MODE_PERIODIC",
		1: "TRIGGER_MODE_PERFORMANCE",
		2: "TRIGGER_MODE_FIXED",
		3: "TRIGGER_MODE_NULL",
	}
...
func (Policy) Descriptor() protoreflect.EnumDescriptor {
	return file_pbft_transport_proto_enumTypes[1].Descriptor()
}

func (Policy) Type() protoreflect.EnumType {
	return &file_pbft_transport_proto_enumTypes[1]
}
...
func (x *ViewID) GetGeneration() uint64 {
	if x != nil {
		return x.Generation
	}
	return 0
...
func (x *ViewID) GetCounter() uint64 {
	if x != nil {
		return x.Counter
	}
	return 0
...
type Action struct {
	...
	Policy        Policy                 `protobuf:"varint,2,opt,name=policy,proto3,enum=pbft.transport.v1.Policy" json:"policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Action) GetTriggerMode() TriggerMode {
	...
	return TriggerMode_TRIGGER_MODE_PERIODIC
}

func (x *Action) GetPolicy() Policy {
	if x != nil {
		return x.Policy
	}
	return Policy_POLICY_ROUND_ROBIN
}
...
type PreprepareMsg struct {
	state                      protoimpl.MessageState `protogen:"open.v1"`
	View                       *ViewID                `protobuf:"bytes,1,opt,name=view,proto3" json:"view,omitempty"`
...
type ViewChangeMsg struct {
	state               protoimpl.MessageState  `protogen:"open.v1"`
	ViewNumber          *ViewID                 `protobuf:"bytes,1,opt,name=view_number,json=viewNumber,proto3" json:"view_number,omitempty"`
...
func (x *ViewChangeMsg) GetAction() *Action {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *NewViewMsg) GetNewViewNumber() *ViewID {
	if x != nil {
...
type RequestVoteMsg struct {
	...
	ViewNumber    *ViewID                `protobuf:"bytes,2,opt,name=view_number,json=viewNumber,proto3" json:"view_number,omitempty"`
...
func (x *RequestVoteMsg) GetViewNumber() *ViewID {
	if x != nil {
		return x.ViewNumber
	}
	return nil
...
func (x *GrantVoteMsg) GetViewNumber() *ViewID {
	if x != nil {
		return x.ViewNumber
	}
	return nil
...
type EpochAggregateMsgMini struct {
	...
	CurrentAction   *Action                `protobuf:"bytes,4,opt,name=current_action,json=currentAction,proto3" json:"current_action,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *EpochAggregateMsgMini) GetCurrentAction() *Action {
	if x != nil {
...
type EpochAggregateMsg struct {
	...
	CurrentAction    *Action                `protobuf:"bytes,5,opt,name=current_action,json=currentAction,proto3" json:"current_action,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *EpochAggregateMsg) GetCurrentAction() *Action {
	if x != nil {
		return x.CurrentAction
	}
	return nil
...
const file_pbft_transport_proto_rawDesc = "" +
	"\n" +
	"\x14pbft_transport.proto\x12\x11pbft.transport.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"B\n" +
	"\x06ViewID\x12\x1e\n" +
	"\n" +
	...
	"\n" +
	"vc_running\x18\x02 \x01(\bR\tvcRunning\"\x92\x02\n" +
	"\rPreprepareMsg\x12-\n" +
	"\x04view\x18\x01 \x01(\v2\x19.pbft.transport.v1.ViewIDR\x04view\x12\x17\n" +
	...
	"\x1ddigest_individual_client_msgs\x18\x06 \x03(\fR\x1adigestIndividualClientMsgsJ\x04\b\x04\x10\x05\"\x91\x01\n" +
	"\x15PreprepareSignPayload\x12-\n" +
	"\x04view\x18\x01 \x01(\v2\x19.pbft.transport.v1.ViewIDR\x04view\x12\x17\n" +
	"\aseq_num\x18\x02 \x01(\x03R\x06seqNum\x12*\n" +
	"\x11digest_client_msg\x18\x03 \x01(\fR\x0fdigestClientMsgJ\x04\b\x04\x10\x05\"\x86\x01\n" +
	"\n" +
	"PrepareMsg\x12-\n" +
	"\x04view\x18\x01 \x01(\v2\x19.pbft.transport.v1.ViewIDR\x04view\x12\x17\n" +
	"\aseq_num\x18\x02 \x01(\x03R\x06seqNum\x12\x16\n" +
	"\x06digest\x18\x03 \x01(\fR\x06digest\x12\x12\n" +
	"\x04from\x18\x04 \x01(\x05R\x04fromJ\x04\b\x05\x10\x06\"\x85\x01\n" +
	"\tCommitMsg\x12-\n" +
	"\x04view\x18\x01 \x01(\v2\x19.pbft.transport.v1.ViewIDR\x04view\x12\x17\n" +
	"\aseq_num\x18\x02 \x01(\x03R\x06seqNum\x12\x16\n" +
	"\x06digest\x18\x03 \x01(\fR\x06digest\x12\x12\n" +
	"\x04from\x18\x04 \x01(\x05R\x04fromJ\x04\b\x05\x10\x06\"\xca\x01\n" +
	"\x11PreprepareMsgMini\x12-\n" +
	"\x04view\x18\x01 \x01(\v2\x19.pbft.transport.v1.ViewIDR\x04view\x12\x17\n" +
	"\aseq_num\x18\x02 \x01(\x03R\x06seqNum\x12*\n" +
	...
	"\x0eprepared_certs\x18\x04 \x03(\v23.pbft.transport.v1.ViewChangeMsg.PreparedCertsEntryR\rpreparedCerts\x121\n" +
	"\x06action\x18\x05 \x01(\v2\x19.pbft.transport.v1.ActionR\x06action\x12+\n" +
	...
	"\x0fview_change_log\x18\x02 \x03(\v2#.pbft.transport.v1.ViewChangeMsgSigR\rviewChangeLog\x12A\n" +
	"\x0fnew_view_number\x18\x03 \x01(\v2\x19.pbft.transport.v1.ViewIDR\rnewViewNumber\x12\x12\n" +
	...
	"newViewMsg\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\"\xdd\x01\n" +
	"\x0eRequestVoteMsg\x12\x12\n" +
	"\x04from\x18\x01 \x01(\x05R\x04from\x12:\n" +
	"\vview_number\x18\x02 \x01(\v2\x19.pbft.transport.v1.ViewIDR\n" +
	"viewNumber\x12\x12\n" +
	...
	"\n" +
	"epoch_data\x18\x03 \x01(\v2\x1c.pbft.transport.v1.EpochDataR\tepochData\x12@\n" +
	"\x0ecurrent_action\x18\x04 \x01(\v2\x19.pbft.transport.v1.ActionR\rcurrentAction\"\xa4\x02\n" +
	"\x11EpochAggregateMsg\x12)\n" +
	"\x10epoch_generation\x18\x01 \x01(\x04R\x0fepochGeneration\x12\x12\n" +
	"\x04from\x18\x02 \x01(\x05R\x04from\x12;\n" +
	"\n" +
	"epoch_data\x18\x03 \x01(\v2\x1c.pbft.transport.v1.EpochDataR\tepochData\x12Q\n" +
	"\x13epoch_data_msg_sigs\x18\x04 \x03(\v2\".pbft.transport.v1.EpochDataMsgSigR\x10epochDataMsgSigs\x12@\n" +
	"\x0ecurrent_action\x18\x05 \x01(\v2\x19.pbft.transport.v1.ActionR\rcurrentAction\"\xbe\t\n" +
	"\bEnvelope\x12\x19\n" +
