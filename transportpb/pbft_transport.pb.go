...
func (ViewChangeMsg_VCType) EnumDescriptor() ([]byte, []int) {
	return file_pbft_transport_proto_rawDescGZIP(), []int{25, 0}
}
...
func (x *Envelope) GetEvent() *EventMsg {
	if x != nil {
...
const file_pbft_transport_proto_rawDesc = "" +
	...
	"\bmsg_type\x18\x02 \x01(\tR\amsgType\")\n" +
	"\bEventMsg\x12\x1d\n" +
	"\n" +
	"event_type\x18\x01 \x01(\tR\teventType\"Y\n" +
...
var file_pbft_transport_proto_goTypes = []any{
	...
	(*EventMsg)(nil),                 // 6: pbft.transport.v1.EventMsg
	(*ClientBatchDigestPayload)(nil), // 7: pbft.transport.v1.ClientBatchDigestPayload
	(*VCRunningStatus)(nil),          // 8: pbft.transport.v1.VCRunningStatus
	(*PreprepareMsg)(nil),            // 9: pbft.transport.v1.PreprepareMsg
	(*PreprepareSignPayload)(nil),    // 10: pbft.transport.v1.PreprepareSignPayload
	(*PrepareMsg)(nil),               // 11: pbft.transport.v1.PrepareMsg
	(*CommitMsg)(nil),                // 12: pbft.transport.v1.CommitMsg
	...
	(*ReplyMessage)(nil),             // 16: pbft.transport.v1.ReplyMessage
	(*CommitTps)(nil),                // 17: pbft.transport.v1.CommitTps
	(*LeaderIdUpdate)(nil),           // 18: pbft.transport.v1.LeaderIdUpdate
	(*CloseMessage)(nil),             // 19: pbft.transport.v1.CloseMessage
	(*CheckpointMsg)(nil),            // 20: pbft.transport.v1.CheckpointMsg
	(*CheckpointMsgSig)(nil),         // 21: pbft.transport.v1.CheckpointMsgSig
	(*PreparedCert)(nil),             // 22: pbft.transport.v1.PreparedCert
	(*ElectionVCData)(nil),           // 23: pbft.transport.v1.ElectionVCData
	(*RoundRobinVCData)(nil),         // 24: pbft.transport.v1.RoundRobinVCData
	(*WRRVCData)(nil),                // 25: pbft.transport.v1.WRRVCData
...
var file_pbft_transport_proto_depIdxs = []int32{
	...
	13, // 9: pbft.transport.v1.PreprepareMsgSig.preprepare_msg_mini:type_name -> pbft.transport.v1.PreprepareMsgMini
	4,  // 10: pbft.transport.v1.PreprepareMsgSig.actual_msg:type_name -> pbft.transport.v1.ClientMsgSignature
	11, // 11: pbft.transport.v1.PrepareMsgSig.prepare_msg:type_name -> pbft.transport.v1.PrepareMsg
...
func file_pbft_transport_proto_init() {
	...
	file_pbft_transport_proto_msgTypes[25].OneofWrappers = []any{
